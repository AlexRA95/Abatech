DROP DATABASE IF EXISTS abatech;
CREATE DATABASE IF NOT EXISTS abatech CHARACTER SET utf8 COLLATE utf8_spanish_ci;

/*Creacion del usuario y se le otorga permisos*/
...
(
    idProducto  SMALLINT auto_increment NOT NULL,
...
(
    idPedido  SMALLINT auto_increment NOT NULL,
    fecha     DATE,
    estado    SET ('c','f') DEFAULT 'c',
...
/*Creacion de tabla de lineasPedidos*/
...
(
    ...
    CONSTRAINT fk_lineasPedidos_pedido FOREIGN KEY (idPedido) REFERENCES pedidos (idPedido)
...
-- Inserción de varios usuarios
INSERT INTO usuarios (email, password, nombre, apellidos, NIF, telefono, direccion, codigoPostal, localidad, provincia,
                      ultimoAcceso, avatar)
VALUES ('juan.perez@gmail.com', md5('12345678'), 'Juan', 'Pérez', '12345678A', '600123456', 'Calle Mayor 10', '28001',
        'Madrid', 'Madrid', '2025-01-22 10:00:00', 'default.png'),
       ('ana.lopez@gmail.com', md5('12345678'), 'Ana', 'López', '87654321B', '610654321', 'Avenida Sol 20', '08002',
        'Barcelona', 'Barcelona', '2025-01-21 15:30:00', 'default.png'),
       ('carlos.garcia@gmail.com', md5('12345678'), 'Carlos', 'García', '45678912C', '620987654', 'Calle Luna 30',
        '41003', 'Sevilla', 'Sevilla', '2025-01-20 18:00:00', 'default.png');

-- Inserción de pedidos asociados a los usuarios
INSERT INTO pedidos (fecha, estado, idUsuario, importe, iva)
VALUES ('2025-01-20', 'c', 1, 150.00, 21.00), -- Pedido de Juan
       ('2025-01-21', 'f', 2, 220.00, 21.00), -- Pedido de Ana
       ('2025-01-22', 'c', 3, 95.00, 21.00); -- Pedido de Carlos

-- Inserción de líneas de pedidos asociadas
INSERT INTO lineasPedidos (idPedido, idProducto, cantidad)
VALUES (1, 1, 1),  -- Juan compró 1 procesador Intel Celeron G1840
       (1, 6, 2),  -- Juan compró 2 memorias Corsair Value Select DDR3
       (2, 3, 1),  -- Ana compró 1 procesador Intel Core i7-4790
       (2, 8, 1),  -- Ana compró 1 SSD Corsair Force Series GS 240GB
       (2, 24, 1), -- Ana compró 1 Hitachi Deskstar 7K4000
       (3, 9, 1),  -- Carlos compró 1 WD Green 2TB SATA3
       (3, 12, 1), -- Carlos compró 1 AeroCool VS-3 Advance Gaming.
       (3, 16, 1); -- Carlos compró 1 AeroCool Strike-X Power 500W.
